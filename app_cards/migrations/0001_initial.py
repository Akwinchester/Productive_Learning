...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_card', models.CharField(default='', max_length=200)),
                ...
                ('last_repetitions_date', models.DateTimeField(default=None)),
                ('number_repetitions', models.IntegerField(default=0)),
                ('link_to_deck', models.ManyToManyField(to='app_cards.decks')),
            ],
        ),
    ]
